...
const About = () => {
  return (
    <div className="w-full p-20 bg-[#CDEA68] text-black rounded-tl-3xl rounded-tr-3xl">
      <h1 className="text-[4vw] leading-[4vw] font-[Neue_Montreal] mt-1 tracking-tight text-zinc-950">
      ...
      <div className="w-full flex gap-5 border-t-[1px] pt-10 border-[#a1b562]">
        <div className="w-1/2">
          ...
          <button className="flex items-center gap-5 px-8 mt-10 py-4 rounded-full bg-zinc-900 text-white transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-zinc-900 hover:shadow-[#CDEA68] hover:shadow-2xl ">
            Read More
