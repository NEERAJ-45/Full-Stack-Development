...
const Navbar = () => {
    ...
    return (
        <div
            className={`parent fixed z-[999] w-full px-20 py-8 font-[Neue Montreal] flex justify-between items-center transition-all duration-300 ${
                isScrolled ? "backdrop-blur-sm   bg-opacity-70" : ""
            }`}
        >
            <div className="logo">
                <svg
            ...
            <div className="links flex gap-10">
                {["Services", "Our Work", "About Us", "Insights", "Contact"].map(
                    (item, index) => (
                        <a
                            className={`text-lg capitalize font-light hover:font-medium ${
                                isScrolled ? "text-black" : "text-inherit" // Change color on scroll
                            } ${index === 4 && "ml-32"}`}
                            key={index}
                        >
                            {item}
